...
public final class BigMath {
  ...
  public static String bigSum(String augend, String addend) {
  ...
  public static String bigProduct(String multiplicand, String multiplier) {
  ...
  public static int bigDigitSum(String n) {
    int sum = 0;
