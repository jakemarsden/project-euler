...
import com.jakemarsden.projecteuler.util.ClasspathResourceLoader;
import com.jakemarsden.projecteuler.util.ResourceLoader;
import com.jakemarsden.projecteuler.util.StringParser;
import java.util.ArrayList;
import java.util.List;

final class NamesScores {

  private final ResourceLoader resLoader;

  NamesScores() {
    this(ClasspathResourceLoader.fromPackage(NamesScores.class));
  }

  NamesScores(ResourceLoader resLoader) {
